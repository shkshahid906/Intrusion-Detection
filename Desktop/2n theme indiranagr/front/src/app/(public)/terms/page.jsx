...
export default function TermsOfService() {
  return (
    <div className="container" style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto', color: 'var(--text-main)' }}>
      ...
      <p style={{ marginBottom: '15px' }}>Welcome to Vape in Indiranagar. By accessing our website and placing an order, you agree to be bound by the following Terms of Service.</p>
      ...
      <p style={{ marginBottom: '15px' }}>We strive to provide same-day delivery across Indiranagar. However, delivery times are subject to traffic and weather conditions. We reserve the right to cancel any order if we suspect fraudulent activity or violation of our age policy.</p>
