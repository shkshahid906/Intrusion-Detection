  ...
  return (
    <div className="container" style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto', color: 'var(--text-main)' }}>
      ...
      <div style={{ padding: '20px', backgroundColor: 'rgba(255, 0, 0, 0.1)', borderLeft: '4px solid #ff4444', borderRadius: '8px', marginBottom: '30px' }}>
        ...
        <p style={{ margin: 0 }}>Vape in Hyderabad maintains a strict zero-tolerance policy for underage vaping. All of our products are strictly intended for adults aged 21 and older.</p>
      </div>
      ...
      <p style={{ marginBottom: '15px' }}>We are committed to operating responsibly within the community of Hyderabad. We actively train our delivery partners to strictly enforce this 21+ policy at the door.</p>
